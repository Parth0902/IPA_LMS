    ...
    <section class="text-gray-600 body-font px-16">
      <div class="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
        <div class="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
          ...
          <p class="mb-2 leading-relaxed"> IPA is the largest Indian professional body for Foot care specialist where our goal is to promote awareness of Diabetic and non diabetic Foot Care and Prevention. The Indian Podiatry Association (IPA) is a dynamic and dedicated non-profit organization focused on improving foot care and wound healing across India and globally. Established with the goal of enhancing the quality of life for patients suffering from diabetic and non-diabetic foot wounds, IPA brings together healthcare professionals from various disciplines, including podiatrists, surgeons, physiotherapists, and other allied healthcare providers. The association serves as a hub for research, education, and advocacy in foot care, providing essential resources and training for medical practitioners.</p>
          <p class="mb-2 leading-relaxed">At IPA, the mission is simple yet powerful: “I Prevent Amputation.” Through education, advocacy, and
          ...
          <p class="mb-2 leading-relaxed">With its expanding reach, IPA remains committed to its mission of saving limbs and lives, one step at a time.
          </p>
        ...
        <div class="flex item-center justify-center lg:max-w-lg lg:w-full md:w-1/2 w-5/6">

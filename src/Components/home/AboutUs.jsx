...
const AboutUs = () => {
  return (
    <section className="text-gray-600 body-font px-6 lg:px-16 bg-slate-100">
      <div className="container mx-auto flex px-5 pt-24 pb-12 md:flex-row flex-col items-center">
        <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
          <h1 className="title-font sm:text-4xl text-3xl mb-4 font-medium text-gray-900">About IPA
          </h1>
          ...
          <p className="mb-2 leading-relaxed text-justify">At IPA, the mission is simple yet powerful: “I Prevent Amputation.” Through education, advocacy, and
          ...
          <p className="mb-2 leading-relaxed text-justify">With its expanding reach, IPA remains committed to its mission of saving limbs and lives, one step at a time.
          </p>
          ...
          <div className="flex justify-center mt-10">
            ...
            <Link
              ...
              className="inline-flex text-white bg-black border-0 py-2 px-6 focus:outline-none hover:bg-gray-200  hover:text-black rounded text-lg transition-all"
            >
              Learn More
            </Link>
          </div>
        </div>
        <div className="flex item-center justify-center lg:max-w-lg lg:w-full md:w-1/2 w-5/6 bg-slate-100">
          <img className="object-cover object-center rounded " alt="hero" src='https://IPA-Images.b-cdn.net/Assets/aboutUs.png' />
        </div>
      </div>
    </section>
  )
